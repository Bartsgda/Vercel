...
> **For Next.js, SvelteKit, Remix, Create React App, Nuxt, Vue, Astro**
...
> **For Next.js, Next.js App Router, Remix, Create React App, Nuxt, Vue, Astro:**
...
#### Using Astro Adapter (versions before @vercel/analytics@1.4.0)
